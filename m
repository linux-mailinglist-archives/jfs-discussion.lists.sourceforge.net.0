...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id ABB924F16B
	for <lists+jfs-discussion@lfdr.de>; Sat, 22 Jun 2019 01:57:16 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.90_1)
	(envelope-from <jfs-discussion-bounces@lists.sourceforge.net>)
	id 1heTOm-0006pi-EW; Fri, 21 Jun 2019 23:56:52 +0000
...
Subject: [Jfs-discussion] [PATCH 2/4] vfs: create a generic checking
