...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 1F9907B19EC
	for <lists+jfs-discussion@lfdr.de>; Thu, 28 Sep 2023 13:07:06 +0200 (CEST)
...
Subject: [Jfs-discussion] [PATCH 87/87] fs: move i_blocks up a few places in
 struct inode
