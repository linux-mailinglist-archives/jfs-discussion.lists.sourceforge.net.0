...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 416FF503238
	for <lists+jfs-discussion@lfdr.de>; Sat, 16 Apr 2022 03:14:10 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.94.2)
	(envelope-from <jfs-discussion-bounces@lists.sourceforge.net>)
	id 1nfX0K-00022P-Gq; Sat, 16 Apr 2022 01:13:37 +0000
...
Subject: [Jfs-discussion] [PATCH 24/27] block: remove QUEUE_FLAG_DISCARD
