...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id A996394930C
	for <lists+jfs-discussion@lfdr.de>; Tue,  6 Aug 2024 16:29:25 +0200 (CEST)
...
Subject: [Jfs-discussion] [linux-next:master] [fs] cdc4ad36a8:
