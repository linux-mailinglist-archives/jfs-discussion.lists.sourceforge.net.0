...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id F1D89431B7A
	for <lists+jfs-discussion@lfdr.de>; Mon, 18 Oct 2021 15:31:48 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.92.3)
	(envelope-from <jfs-discussion-bounces@lists.sourceforge.net>)
	id 1mcSjh-0002Dn-NV; Mon, 18 Oct 2021 13:31:29 +0000
...
Subject: [Jfs-discussion] [PATCH 14/30] fat: use bdev_nr_sectors instead of
 open coding it
