...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 1600B7473E4
	for <lists+jfs-discussion@lfdr.de>; Tue,  4 Jul 2023 16:18:08 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <jfs-discussion-bounces@lists.sourceforge.net>)
	id 1qGgqW-0000jF-6b;
	Tue, 04 Jul 2023 14:17:36 +0000
...
X-Mailman-Approved-At: Tue, 04 Jul 2023 14:17:23 +0000
Subject: [Jfs-discussion] [PATCH 32/32] block: Rename
 blkdev_get_handle_by_*() and blkdev_handle_put()
