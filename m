...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 277B14F5571
	for <lists+jfs-discussion@lfdr.de>; Wed,  6 Apr 2022 08:06:23 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-1.v29.lw.sourceforge.com)
	by sfs-ml-1.v29.lw.sourceforge.com with esmtp (Exim 4.94.2)
	(envelope-from <jfs-discussion-bounces@lists.sourceforge.net>)
	id 1nbyny-0001Fn-Ob; Wed, 06 Apr 2022 06:06:09 +0000
...
Subject: [Jfs-discussion] [PATCH 09/27] mm: use bdev_is_zoned in
 claim_swapfile
