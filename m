...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 8373DC41E66
	for <lists+jfs-discussion@lfdr.de>; Fri, 07 Nov 2025 23:53:56 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	bh=Zdbz4TQdCB62o30k/SJ+cGbR4rjqNWfXAbboQtfj834=; b=Lo28f4mxtAGbLuKlJW9CGj3CHB
	LWp/TsMVjCI8Hb1UHDFNdEprNkW5pMBvORta+zh9VIapaZUCRRW98hfumhfqi7qmItslGgLmZKdET
	BEn0VEoYfnu9viyIPNuQaHsC5vOdd9C6d05KR5/a3UuHqeho3Q/G4Vs480NldzGlmVDA=;
...
Subject: [Jfs-discussion] LLM disclosure (was: [PATCH v2] vfs: remove the
 excl argument from the ->create() inode_operation)
...
From: Jonathan Corbet via Jfs-discussion <jfs-discussion@lists.sourceforge.net>
