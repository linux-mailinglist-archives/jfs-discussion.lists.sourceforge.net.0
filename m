...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 856733C27E
	for <lists+jfs-discussion@lfdr.de>; Tue, 11 Jun 2019 06:46:33 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-1.v29.lw.sourceforge.com)
	by sfs-ml-1.v29.lw.sourceforge.com with esmtp (Exim 4.90_1)
	(envelope-from <jfs-discussion-bounces@lists.sourceforge.net>)
	id 1haYfk-0001jy-FQ; Tue, 11 Jun 2019 04:46:12 +0000
...
Subject: [Jfs-discussion] [PATCH 0/4] vfs: clean up SETFLAGS and FSSETXATTR
 option processing
