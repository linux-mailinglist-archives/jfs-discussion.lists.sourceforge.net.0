...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 826BF7BE604
	for <lists+jfs-discussion@lfdr.de>; Mon,  9 Oct 2023 18:10:59 +0200 (CEST)
...
Subject: Re: [Jfs-discussion] [PATCH v2 00/89] fs: new accessor methods for
