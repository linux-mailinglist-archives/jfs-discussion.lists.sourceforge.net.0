...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 5F4CA4199C
	for <lists+jfs-discussion@lfdr.de>; Wed, 12 Jun 2019 02:43:45 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.90_1)
	(envelope-from <jfs-discussion-bounces@lists.sourceforge.net>)
	id 1harMQ-0005I5-HN; Wed, 12 Jun 2019 00:43:30 +0000
...
Subject: [Jfs-discussion] [PATCH v2 1/4] vfs: create a generic checking
