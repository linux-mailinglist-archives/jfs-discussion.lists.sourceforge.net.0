...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 46148656322
	for <lists+jfs-discussion@lfdr.de>; Mon, 26 Dec 2022 15:22:42 +0100 (CET)
...
Subject: [Jfs-discussion] [RFC PATCH v2 16/18] cifs: Do not use broken utf8
