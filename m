...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id C04147B007A
	for <lists+jfs-discussion@lfdr.de>; Wed, 27 Sep 2023 11:35:21 +0200 (CEST)
...
Subject: [Jfs-discussion] [PATCH v4 0/29] block: Make blkdev_get_by_*()
 return handle
