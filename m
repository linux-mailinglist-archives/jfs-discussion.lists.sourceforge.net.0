...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 86DAB65631F
	for <lists+jfs-discussion@lfdr.de>; Mon, 26 Dec 2022 15:22:40 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <jfs-discussion-bounces@lists.sourceforge.net>)
	id 1p9oMy-0001z3-9g;
	Mon, 26 Dec 2022 14:22:24 +0000
...
Subject: [Jfs-discussion] [RFC PATCH v2 11/18] hfsplus: Do not use broken
